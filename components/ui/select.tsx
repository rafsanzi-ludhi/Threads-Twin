...
// Root select component using Radix UI primitive
const Select = SelectPrimitive.Root
// Group component for grouping select items
const SelectGroup = SelectPrimitive.Group
// Component to hold the selected value
const SelectValue = SelectPrimitive.Value

// Custom Select Trigger component with Chevron Icon
...
const SelectItem = React.forwardRef<
  ...
  >(({ className, children, ...props }, ref) => (
    // Define the look and feel of individual Select items
...
// Separator component for the Select items
...
// Export all the custom components
