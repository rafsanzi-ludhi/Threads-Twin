...
// Define the Tabs component from the primitive
const Tabs = TabsPrimitive.Root;

// TabsList Component with forwarded Ref
const TabsList = React.forwardRef<
  React.ElementRef<typeof TabsPrimitive.List>,
  React.ComponentPropsWithoutRef<typeof TabsPrimitive.List>
>(
  // Use Tailwind CSS classes for styling and allow overriding through className prop
  ({ className, ...props }, ref) => (
    <TabsPrimitive.List
      ref={ref}
      className={cn(
...
// TabsTrigger Component with forwarded Ref
...
// TabsContent Component with forwarded Ref
